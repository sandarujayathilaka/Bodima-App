...
import com.example.bodima.fragments.FurnitureAddFragment
...
@SmallTest
class FurnitureAddFragmentTest {

    private lateinit var scenario: FragmentScenario<FurnitureAddFragment>
    ...
    fun setup() {
        ...
        val scenario = launchFragmentInContainer<FurnitureAddFragment>(
